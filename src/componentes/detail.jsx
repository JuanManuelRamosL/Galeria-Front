...
function Detail() {
  ...
  const eliminar = async () => {
    ...
    const response = await axios.post(
      `https://galery-back.onrender.com/delete`,
      {
    ...
    <>
      ...
      <div className="container_d" id="">
        ...
        <section className="section">
          <small className="likes">{imageID.likes} ❤️</small>
          <small className="fecha">Fecha: {imageID.updated_at}</small>
          <small className="usuario" onClick={navArtist}>
            Usuario: {imageID.user.instagram_username}
          </small>
          {!isFav ? (
            <svg
              className="svg"
